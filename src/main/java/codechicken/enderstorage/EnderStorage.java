...
@Mod(modid = "EnderStorage", name = "EnderStorage", version = "GRADLETOKEN_VERSION", dependencies = "required-after:CodeChickenCore@[" + CodeChickenCorePlugin.version + ",)", acceptedMinecraftVersions = CodeChickenCorePlugin.mcVersion)
